#Code Source: https://github.com/GoogleCloudPlatform/devrel-demos/blob/main/ai-ml/agent-labs/gemini-3-pro-agent-demo/my_agent/agent.py
...
root_agent = Agent(
    name="search_agent",
    model="gemini-2.5-flash", #Gemini Models: https://ai.google.dev/gemini-api/docs/models
